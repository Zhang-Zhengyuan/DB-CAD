...
static void get_triangles_from_faceted_faces(ENTITY_LIST& faces, std::vector<GmeMesh::FaceMesh>& faceData, std::vector<float>& coords, std::vector<int>& triangles, std::vector<float>& normalCoords) {
    int nF = 0;
    int nV = 0;
    int nI = 0;
...
static void get_polylines_from_faceted_edges(ENTITY_LIST& edges, std::vector<GmeMesh::EdgeMesh>& edgeData, std::vector<float>& coords) {
    int nE = 0;
    int nV = 0;
